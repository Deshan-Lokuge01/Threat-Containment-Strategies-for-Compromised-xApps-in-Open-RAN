#!/usr/bin/env python3
"""R6 stealth-combined, rigorously-instrumented network-isolation
demonstration run. Same attack_fn as run_r6_trials.py (unchanged
cpu/vm/hdd/duration), routed through the same upgraded trial_harness_
common.run_trial() used by run_r1_network_demo.py, appending to the SAME
demo output files alongside R1's/A_Burst's/A_Stealth's already-collected
trials -- the canonical N=51 statistical dataset is never touched.

Run with: python3 run_r6_network_demo.py [N_TRIALS]
"""
import sys
